...
import com.encephalon.fx.sankeyplot.tools.CtxBounds;
import com.encephalon.fx.sankeyplot.tools.Helper;
import com.encephalon.fx.sankeyplot.tools.Point;
import java.net.URL;
...
public class SankeyPlot extends Region {
    ...
    // ******************** Constructors **************************************
    public SankeyPlot() {
        URL u = SankeyPlot.class.getResource("/resource/sankey-plot.css");
        getStylesheets().add(u.toExternalForm());
...
//                    List<PlotItemData> nextLevelItemDataList = itemsPerLevel.get(nextLevel);
                    List<PlotItemData> nextLevelItemDataList = new LinkedList<>();  
                    for (int i=nextLevel;i <= maxLevel;i++) {
                        nextLevelItemDataList.addAll(itemsPerLevel.get(i));
                    }
